"""
walmart_tv_detail_crawled 테이블에 count_of_reviews 컬럼 추가
"""
import psycopg2
...
def add_count_of_reviews_column():
    try:
        ...
        print("="*80)
        print("walmart_tv_detail_crawled 테이블에 count_of_reviews 컬럼 추가")
        print("="*80)

        # count_of_reviews 컬럼 추가
        ...
        if not cursor.fetchone():
            cursor.execute("""
                ...
                ADD COLUMN count_of_reviews INTEGER
            """)
        ...
        conn.commit()
        print("\n" + "="*80)
        print("[SUCCESS] count_of_reviews 컬럼 추가 완료!")
        print("="*80)
