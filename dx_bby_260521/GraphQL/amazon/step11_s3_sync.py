...
from .step00_config import DEFAULT_AMAZON_RUN_ROOT, amazon_product_type, amazon_run_date, rel_path
...
def s3_uri():
    parts = [part for part in [S3_PREFIX, "amazon", PRODUCT_TYPE, RUN_DATE] if part]
