...
from .step00_config import DEFAULT_AMAZON_RUNS_BASE, amazon_product_type, amazon_run_date, rel_path


PRODUCT_TYPE = amazon_product_type().lower()
RUN_DATE = amazon_run_date()
PRODUCT_ROOT = DEFAULT_AMAZON_RUNS_BASE / PRODUCT_TYPE
RUN_ROOT = Path(os.getenv("AMAZON_RUN_ROOT", str(PRODUCT_ROOT / RUN_DATE)))
