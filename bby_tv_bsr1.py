...
class BestBuyBSRCrawler:
    def __init__(self):
        ...
        if os.environ.get('TEST_MODE') == '1':
            ...
            self.max_products = self.config.get_int('constant', 'max_products_bsr', self.file_name, 100)
    ...
    def load_page_urls(self):
        ...
        default_urls = [
            ...
            (2, 'https://www.bestbuy.com/site/searchpage.jsp?id=pcat17071&sp=Best-Selling&st=tv&page=2'),
        ]
        if not self.db_conn:
        ...
        try:
            ...
            table_name = self.config.get_table('bsr_page_url')
            cursor.execute(f"""
        ...
        try:
            ...
            for idx, container in enumerate(containers, 1):
                ...
                try:
                    ...
                    page_type = self.config.get_constant('page_type_bsr', self.file_name, 'bsr')
                    if self.save_to_db(
                        page_type=page_type,
