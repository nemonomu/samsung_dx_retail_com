...
STEPS = [
    ...
    Step(
        ...
        "bestbuy.step08_detail_enrichment",
        {
            ...
            "BESTBUY_DETAIL_RETRY_ON_MISSING_SIMILAR": "1",
            "BESTBUY_DETAIL_MAX_ATTEMPTS": "2",
            "BESTBUY_DETAIL_USE_DB_SELECTORS": "0",
            "BESTBUY_DETAIL_WORKERS": "2",
            "ZENROWS_TIMEOUT": "260",
        },
        {
            "BESTBUY_DETAIL_STAGE": "detail",
    ...
    Step(
        ...
        {"BESTBUY_DETAIL_WORKERS": "3", "BESTBUY_DETAIL_MAX_ATTEMPTS": "1", "ZENROWS_TIMEOUT": "240"},
        {
            "BESTBUY_DETAIL_RETRY_ONLY": "1",
