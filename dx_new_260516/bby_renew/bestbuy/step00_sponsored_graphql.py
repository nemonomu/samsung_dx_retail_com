...
def build_sponsored_payload(skus):
    ...
    query = (
        ...
        "{skuId customerPrice displayableCustomerPrice regularPrice displayableRegularPrice "
        ...
        "offers(input:{salesChannel:\"LargeView\" maxOffers:10 checkmarkMessagingRequired:true "
        "filterFinanceMinPurchaseAmount:false}){offers{hotOffer offerId offerType complexMemberOffer}}}"
